...
homePath: '/satzmodelle/fonte-7-1'
...
- Im ersten "Paket" passiert eine Dominant-zu-Tonika-Fortschreitung (hier per Sopranklausel im Bass). Im zweiten Paket geschieht das Gleiche, allerdings um eine Tonleiterstufe nach **unten** verschoben
...
die formal und harmonisch an bestimmten Stellen eines [Menuetts](https://www.musiklexikon.ac.at/ml/musik_M/Menuett.xml) stehen (als «Mittelteil»). Fonte ist im Unterschied zur Quintfallsequenz eine Sequenz die schrittweise 5 – 1 im Fundamentbass (hier per Sopranklausel im Bass) fällt, wobei sich die 5 –Stufe zwingend dominantisch verhält. Diese Sequenz hat in der Regel nur zwei Sequenzglieder und endet entweder auf der I-Stufe, oder auf der V-Stufe.
::
